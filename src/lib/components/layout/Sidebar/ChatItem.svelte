<script lang="ts">
	...
	// Check if this is a symposium chat
	$: isSymposium = mode === 'symposium';
	...
	{:else}
		...
		>
			<div class=" flex self-center flex-1 w-full">
				{#if isSymposium}
					<div class="flex-shrink-0 mr-1.5 self-center" title="Symposium">
						<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-3.5 h-3.5 text-emerald-500">
